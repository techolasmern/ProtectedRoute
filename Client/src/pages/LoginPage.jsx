...
export const LoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await api.post("/api/mail/otp/send", { email: formData.email });
    ...
    return <Fragment>
        {
            showOtpComponent ? <OtpComponent email={formData.email} callback={completeLogin} /> : <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] px-6">
